...
public class TambahSLL_2511532029 {
    ...
    public static NodeSSL_2511532029 insertAtFront(
    ...
    public static NodeSSL_2511532029 insertAtEnd(
        NodeSSL_2511532029 head,
        int value
    ) {
    ...
    static NodeSSL_2511532029 insertPos(
        NodeSSL_2511532029 headNode_2029,
        int position,
        int value
    ) {
    ...
    public static void printList(NodeSSL_2511532029 head) {
        ...
        while (curr_2029 != null) {
            ...
            if (curr_2029.next_2029 != null) System.out.print("-->");
