...
public class RumahSakit_2511532029 {
    ...
    public void daftarkanPasien_2029(String nama_2029, String keluhan_2029) {
        counterAntrian_2029++;
        Pasien_2511532029 baru = new Pasien_2511532029(
            nama_2029,
            keluhan_2029,
            counterAntrian_2029
        );
        ...
        jumlahPasien_2029++;
        System.out.println(
            "Pasien berhasil didaftarkan! Nomor Antrian: " + counterAntrian_2029
        );
    }
    ...
    public void panggilPasien_2029() {
        ...
        System.out.println("\n=== Pasien Dipanggil ===");
        System.out.println(
            "Nomor Antrian : " + pasienDipanggil_2029.getNomorAntrian_2029()
        );
        System.out.println(
            "Nama Pasien   : " + pasienDipanggil_2029.getNamaPasien_2029()
        );
        System.out.println(
            "Keluhan       : " + pasienDipanggil_2029.getPenyakit_2029()
        );
        System.out.println("========================\n");
    ...
    public void tampilkanAntrian_2029() {
        //Tampilkan antrean
        if (head_2029 == null) {
        ...
        while (current_2029 != null) {
            System.out.println(
                posisi_2029 +
                    ". No. Antrian: " +
                    current_2029.getNomorAntrian_2029() +
                    " | Nama: " +
                    current_2029.getNamaPasien_2029() +
                    " | Keluhan: " +
                    current_2029.getPenyakit_2029()
            );
    ...
    public void cariPasien_2029(String nama_2029) {
        //Cari pasien
        if (head_2029 == null) {
        ...
        while (current_2029 != null) {
            if (current_2029.getNamaPasien_2029().equalsIgnoreCase(nama_2029)) {
                ...
                System.out.println(
                    "Nomor Antrian : " + current_2029.getNomorAntrian_2029()
                );
                System.out.println(
                    "Nama Pasien   : " + current_2029.getNamaPasien_2029()
                );
                System.out.println(
    ...
    public void cekStatusAntrian_2029() {
        //Cek status antrian
        if (head_2029 == null) {
        ...
        System.out.println(
            "Pasien terdepan: " +
                head_2029.getNamaPasien_2029() +
                " (No. Antrian " +
                head_2029.getNomorAntrian_2029() +
                ")"
        );
        System.out.println("=======================");
    }

    public void jalankanMenu_2029() {
